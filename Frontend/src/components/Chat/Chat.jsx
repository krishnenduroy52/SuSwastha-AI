...
function Chat() {
  ...
  const [chats, setChats] = useState([
    {
      user: "gpt",
      chat: "Hi, My name is SuSwastha AI, Ask me helth related queries.",
    },
  ]);
      ...
      <div className="chat_header_text">
        ...
        <p>
          <FontAwesomeIcon
            ...
            style={{ color: "red" }}
          />
          SuSwastha.AI Health Assistant is for informational purposes only.
          Don’t take any actions without a doctor’s validation or consultation.
        </p>
      </div>
